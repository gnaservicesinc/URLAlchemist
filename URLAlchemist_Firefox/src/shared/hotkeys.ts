...
const RESERVED_HOTKEYS: Record<HotkeyPlatform, Record<string, string>> = {
  mac: {
    'Command+,': 'Command+, usually opens browser settings on macOS. Pick a different shortcut.',
    'Command+H': 'Command+H usually hides the current app on macOS. Pick a different shortcut.',
    'Command+L': 'Command+L usually focuses the address bar in the browser. Pick a different shortcut.',
    'Command+M': 'Command+M usually minimizes the current window on macOS. Pick a different shortcut.',
    'Command+N': 'Command+N usually opens a new window in the browser. Pick a different shortcut.',
    'Command+P': 'Command+P usually opens print in the browser. Pick a different shortcut.',
    'Command+Q': 'Command+Q usually quits the browser on macOS. Pick a different shortcut.',
    'Command+R': 'Command+R usually reloads the current page in the browser. Pick a different shortcut.',
    'Command+T': 'Command+T usually opens a new tab in the browser. Pick a different shortcut.',
    'Command+W': 'Command+W usually closes the current tab in the browser. Pick a different shortcut.',
    'Command+Space': 'Command+Space is commonly reserved by macOS. Pick a different shortcut.',
    'Command+Shift+I': 'Command+Shift+I usually opens developer tools in the browser. Pick a different shortcut.',
  },
  other: {
    ...
    'Ctrl+H': 'Ctrl+H usually opens browsing history in the browser. Pick a different shortcut.',
    'Ctrl+L': 'Ctrl+L usually focuses the address bar in the browser. Pick a different shortcut.',
    'Ctrl+N': 'Ctrl+N usually opens a new window in the browser. Pick a different shortcut.',
    'Ctrl+P': 'Ctrl+P usually opens print in the browser. Pick a different shortcut.',
    'Ctrl+R': 'Ctrl+R usually reloads the current page in the browser. Pick a different shortcut.',
    'Ctrl+S': 'Ctrl+S usually opens save in the browser. Pick a different shortcut.',
    'Ctrl+T': 'Ctrl+T usually opens a new tab in the browser. Pick a different shortcut.',
    'Ctrl+W': 'Ctrl+W usually closes the current tab in the browser. Pick a different shortcut.',
    'Ctrl+Shift+I': 'Ctrl+Shift+I usually opens developer tools in the browser. Pick a different shortcut.',
  },
};
