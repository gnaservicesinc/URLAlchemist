...
SOURCE_DIR="$STAGING_DIR/URLAlchemist_chrome"
...
SOURCE_TARBALL_NAME="URLAlchemist_Chrome_${VERSION}_source.tar.gz"
...
COPYFILE_DISABLE=1 zip -X -qr "$ARTIFACT_DIR/$PACKAGE_NAME" URLAlchemist_chrome
COPYFILE_DISABLE=1 tar -czf "$ARTIFACT_DIR/$SOURCE_TARBALL_NAME" URLAlchemist_chrome
