...
export function HotkeyRecorder({ onChange, validationError, value }: HotkeyRecorderProps) {
  ...
  return (
    <div className="field-shell">
      ...
      <p className="text-xs text-slate-500">
        Hotkeys work on normal web pages. Chrome-owned pages like <span className="font-mono">chrome://</span> and the
        Chrome Web Store block extension scripts, so shortcuts cannot run there.
      </p>
    </div>
  );
}
