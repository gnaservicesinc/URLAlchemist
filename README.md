...
- Trigger support for page input data, context menus, hotkeys, intervals, and event-driven overlays.
- String, regex, list, dictionary, logic, math, loop, Substitution, Abort, SaveLoad, and shared-state blocks for building reusable workflows without custom code.
